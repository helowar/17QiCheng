package com.qicheng.framework.net;
...
public class HttpDownloader {
    ...
    private void postEvent(HttpResultCallback.HttpDownloaderResult success) {
        if (mCallback != null) {
            mCallback.onResponse(success, this.mUrl, this.mFileName);
        }
    }

    private HttpResultCallback.HttpDownloaderResult work() {
        HttpResultCallback.HttpDownloaderResult result = HttpResultCallback.HttpDownloaderResult.eNone;
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    e.printStackTrace();
                    return HttpResultCallback.HttpDownloaderResult.eUrlIllegal;
                }
                conn = (HttpURLConnection) url.openConnection();
            } catch (IOException e) {
                e.printStackTrace();
                return HttpResultCallback.HttpDownloaderResult.eOpenUrlError;
            }
