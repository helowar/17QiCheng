...
import com.qicheng.framework.image.Photo;
import com.qicheng.framework.image.PhotoDownloadCompleteEventArgs;
import com.qicheng.framework.net.HttpDownloader;
    ...
    public Pair<Bitmap, Boolean> getBitmapAndNeedDownload(Photo photo, Photo.Size size) {
        ...
        if (StringUtil.isEmpty(photo.getUrl())) {
            if (photo.getResId() == 0) {
                ...
                photo.setResId(R.drawable.ic_default_photo);
            }
            // 带有资源id的照片
        ...
        return new Pair<Bitmap, Boolean>(
                BitmapFactory.decodeResource(Const.Application.getResources(), R.drawable.ic_default_photo),
                true);
    }
