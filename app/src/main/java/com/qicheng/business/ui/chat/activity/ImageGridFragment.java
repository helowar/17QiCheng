...
import com.qicheng.business.ui.chat.utils.VideoEntity;
import com.qicheng.business.ui.chat.utils.video.ImageCache;
import com.qicheng.business.ui.chat.utils.ImageResizer;
import com.qicheng.business.ui.chat.utils.video.Utils;
import com.qicheng.business.ui.chat.widget.RecyclingImageView;
...
public class ImageGridFragment extends Fragment implements OnItemClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mImageResizer.setLoadingImage(R.drawable.ic_default_photo);
	...
	private class ImageAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup container) {
			...
			if(position==0)
			{
				...
				holder.imageView.setImageResource(R.drawable.ic_default_photo);
