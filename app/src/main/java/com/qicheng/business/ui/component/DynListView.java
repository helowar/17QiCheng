...
public class DynListView extends ListView implements AbsListView.OnScrollListener {
    ...
    private void init(Context context) {
        ...
        headerView = (LinearLayout) inflater.inflate(R.layout.dyn_listview_head, null);
    ...
    private void toLastFresh() {
        if (refreshListener != null) {
            refreshListener.toLastRefresh();
        }
    }

    public void setAdapter(ActyFragment.DynListViewAdapter adapter) {
        lvHeaderLastUpdatedTv.setText("最近更新:" + new Date().toLocaleString());
