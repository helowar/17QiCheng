...
import com.qicheng.business.image.LoadLocalBigImgTask;
...
public class ShowBigImage extends BaseActivity {
	...
	private int default_res = R.drawable.ic_default_photo;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		default_res = getIntent().getIntExtra("default_image", R.drawable.ic_default_portrait);
