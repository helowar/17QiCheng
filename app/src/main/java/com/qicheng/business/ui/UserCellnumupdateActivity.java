...
public class UserCellnumupdateActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_information_cellnum_modify);
        ...
        mVerifyCode.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void afterTextChanged(Editable s) {
                if (!StringUtil.isEmpty(s.toString()) && !StringUtil.isEmpty(cellNum)) {
                    mSubmitButton.setEnabled(true);
                } else {
                    mSubmitButton.setEnabled(false);
                }
        ...
        mSubmitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (StringUtil.isEmpty(mVerifyCode.getText().toString())) {
                    Alert.Toast("请填写正确信息");
                }
    ...
    private void getVerifyCode(String cellNum) {
        ...
        userLogic.getVerifyCode(cellNum, Const.ACTION_TYPE_MODIFY, createUIEventListener(new EventListener() {
            @Override
    ...
    private void doModify(String cellNum) {
        UserLogic userLogic = (UserLogic) LogicFactory.self().get(LogicFactory.Type.User);
        userLogic.updateCellNum(cellNum, mVerifyCode.getText().toString(), createUIEventListener(new EventListener() {
            @Override
            public void onEvent(EventId id, EventArgs args) {
                stopLoading();
                OperErrorCode errCode = ((StatusEventArgs) args).getErrCode();
